...
namespace DoctorAppointment.RazorPages.Areas.Patient.Pages.Appointments
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            IEnumerable<AppointmentModel> appointments = (await _appointmentService.ListAppointmentsAsync(patientId: User.GetUserId())).Select(appointment => (AppointmentModel)appointment);
